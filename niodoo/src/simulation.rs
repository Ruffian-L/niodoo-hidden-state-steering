...
pub(crate) async fn run_simulation(
    ...
    let mut phys_engine = PrincipiaEngine {
        ...
        correction_packet_neighborhood_weighting: args.correction_packet_neighborhood_weighting,
        correction_packet_neighborhood_gain: args.correction_packet_neighborhood_gain,
        last_correction_packet_basin_coherence: 0.0,
